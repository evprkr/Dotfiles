...
if &background == "light"
  ...
  let s:gui01 = "#eeede7"
  let s:gui02 = "#d6d6d3"
  let s:gui03 = "#858583" " original: #c0c0bd
  let s:gui04 = "#7a7b75"
  let s:gui05 = "#484e54"
  let s:gui06 = "#2f3337"
  let s:gui07 = "#070708"
  let s:gui08 = "#ff9505" " originally red, changed to orange
  let s:gui09 = "#f7546f" " originally orange, changed to red
  let s:gui0A = "#ffb627"
  let s:gui0B = "#02d849"
  let s:gui0C = "#0ed1d1"
  let s:gui0D = "#4bc1fc"
  let s:gui0E = "#ec44eb"
  let s:gui0F = "#b27701"
  let s:guiBG = "#17181B" " original: #232529
  let s:guiFG = "#f8f8f2"
endif
